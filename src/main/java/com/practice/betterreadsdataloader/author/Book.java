package com.practice.betterreadsdataloader.author;
...
public Book(String id, String name, String description, LocalDate publishedDate, List<String> coverIds,
        List<String> authorNames, List<String> authorId) {
    this.id = id;
    this.name = name;
    this.description = description;
    this.publishedDate = publishedDate;
